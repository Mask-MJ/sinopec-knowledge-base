...
export default async () => {
  const t = {
    ['./common/dto/base.dto']: await import('./common/dto/base.dto'),
    ['./modules/system/dept/dept.entity']:
      await import('./modules/system/dept/dept.entity'),
    ['./modules/system/menu/menu.entity']:
      await import('./modules/system/menu/menu.entity'),
    ['./modules/system/role/role.entity']:
      await import('./modules/system/role/role.entity'),
    ['./common/dto/upload.dto']: await import('./common/dto/upload.dto'),
  };
  return {
    '@nestjs/swagger': {
      models: [
            ...
            BaseDto: {
              ...
              order: {
                ...
                description:
                  '\u6392\u5E8F\u987A\u5E8F asc \u6B63\u5E8F, desc \u5012\u5E8F',
                example: 'asc',
                enum: t['./common/dto/base.dto'].SortOrder,
              },
        ...
        [
          import('./modules/monitor/login-log/login-log.dto'),
          {
            CreateLoginLogDto: {
              browser: {
                required: true,
        ...
        [
          import('./modules/monitor/login-log/login-log.entity'),
          {
            LoginLogEntity: {
              ...
              loginTime: { required: true, type: () => Date },
        ...
        [
          import('./modules/monitor/operation-log/operation-log.dto'),
          {
        ...
        [
          import('./modules/monitor/operation-log/operation-log.entity'),
          {
            OperationLogEntity: {
              address: { required: true, type: () => String },
              businessType: { required: true, type: () => Number },
        ...
        [
          import('./modules/system/dept/dept.entity'),
          {
            DeptEntity: {
              ...
              id: { required: true, type: () => Number },
              leader: { required: true, type: () => String, nullable: true },
              leaderId: { required: true, type: () => Number, nullable: true },
        ...
        [
          import('./modules/system/dict/dict.dto'),
          {
            CreateDictDto: {
              name: {
                required: true,
        ...
        [
          import('./modules/system/dict/dict.entity'),
          {
            DictEntity: {
              createdAt: { required: true, type: () => Date },
              id: { required: true, type: () => Number },
            ...
            DictDataEntity: {
              createdAt: { required: true, type: () => Date },
              dictId: { required: true, type: () => Number },
              id: { required: true, type: () => Number },
              name: { required: true, type: () => String },
              order: { required: true, type: () => Number },
              remark: { required: true, type: () => String },
        ...
        [
          import('./modules/system/menu/menu.entity'),
          {
            MenuEntity: {
              ...
              affixTab: { required: true, type: () => Boolean },
              affixTabOrder: { required: true, type: () => Number },
              badge: { required: true, type: () => String, nullable: true },
              badgeType: { required: true, type: () => String },
              badgeVariants: { required: true, type: () => String },
              children: {
                required: false,
                type: () => [t['./modules/system/menu/menu.entity'].MenuEntity],
                nullable: true,
              },
              hideChildrenInMenu: { required: true, type: () => Boolean },
              hideInBreadcrumb: { required: true, type: () => Boolean },
              hideInMenu: { required: true, type: () => Boolean },
              hideInTab: { required: true, type: () => Boolean },
              icon: { required: true, type: () => String, nullable: true },
              id: { required: true, type: () => Number },
              iframeSrc: { required: true, type: () => String, nullable: true },
              keepAlive: { required: true, type: () => Boolean },
              link: { required: true, type: () => String, nullable: true },
              maxNumOfOpenTabs: {
                required: true,
                type: () => Number,
                nullable: true,
              ...
              name: { required: true, type: () => String },
              noBasicLayout: { required: true, type: () => Boolean },
              openInNewWindow: { required: true, type: () => Boolean },
              order: { required: true, type: () => Number },
              parentId: { required: true, type: () => Number, nullable: true },
        ...
        [
          import('./modules/system/user/user.entity'),
          {
            UserEntity: {
              ...
              createdAt: { required: true, type: () => Date },
              deptId: { required: true, type: () => Number, nullable: true },
              email: { required: true, type: () => String },
              id: { required: true, type: () => Number },
              isAdmin: { required: true, type: () => Boolean },
              isDeptAdmin: { required: true, type: () => Boolean },
          ...
          import('./common/dto/upload.dto'),
          {
            ...
            FilesUploadDto: {
              ...
              type: {
                ...
                description: '\u6587\u4EF6\u7C7B\u578B',
                example: 'images',
                enum: t['./common/dto/upload.dto'].FileType,
              },
            },
          },
        ],
        [
          import('./modules/knowledge-base/knowledge-base.dto'),
          {
        ...
        [
          import('./modules/assistant/assistant.dto'),
          {
            CreateAssistantDto: {
              avatar: {
                required: false,
            ...
            QueryAssistantDto: {},
            UpdateAssistantDto: { id: { required: true, type: () => Number } },
            CreateSessionDto: {
              name: {
                required: false,
                type: () => String,
            ...
            UpdateSessionDto: { id: { required: true, type: () => String } },
        ...
        [
          import('./modules/assistant/assistant.entity'),
          {
            AssistantEntity: {
              assistantId: {
                required: true,
              ...
              frequencyPenalty: { required: true, type: () => Number },
              id: { required: true, type: () => Number },
              keywordsSimilarityWeight: { required: true, type: () => Number },
              maxTokens: { required: true, type: () => Number },
              modelName: { required: true, type: () => String },
              name: { required: true, type: () => String },
              opener: { required: true, type: () => String, nullable: true },
              presencePenalty: { required: true, type: () => Number },
              prompt: { required: true, type: () => String, nullable: true },
              similarityThreshold: { required: true, type: () => Number },
              temperature: { required: true, type: () => Number },
              topK: { required: true, type: () => Number },
              topN: { required: true, type: () => Number },
            ...
            SessionEntity: {
              ...
              createDate: { required: true, type: () => String },
        ...
        [
          import('./modules/knowledge-base/knowledge-base.entity'),
          {
            KnowledgeBaseEntity: {
              avatar: { required: true, type: () => String, nullable: true },
              chunkMethod: { required: true, type: () => String },
              createBy: { required: true, type: () => String },
              createdAt: { required: true, type: () => Date },
              datasetId: { required: true, type: () => String, nullable: true },
              deptId: { required: true, type: () => Number, nullable: true },
              description: {
                required: true,
                type: () => String,
              ...
              name: { required: true, type: () => String },
              order: { required: true, type: () => Number },
              parserConfig: { required: true, type: () => Object },
              permission: {
                required: true,
                type: () => String,
                nullable: true,
            ...
            DocumentEntity: {
              chunkMethod: { required: true, type: () => String },
              chunkNum: { required: true, type: () => Number },
              createDate: { required: true, type: () => String },
              createdBy: { required: true, type: () => String },
              createTime: { required: true, type: () => Number },
              datasetId: { required: true, type: () => String },
              id: { required: true, type: () => String },
              location: { required: true, type: () => String },
              metaFields: { required: true, type: () => Object },
              name: { required: true, type: () => String },
              parserConfig: { required: true, type: () => Object },
              processBeginAt: {
                required: true,
              ...
              processDuration: { required: true, type: () => Number },
              progress: { required: true, type: () => Number },
              progressMsg: { required: true, type: () => String },
              ...
              tokenNum: { required: true, type: () => Number },
              type: { required: true, type: () => String },
              updateDate: { required: true, type: () => String },
              updateTime: { required: true, type: () => Number },
            },
            ChunkEntity: {
              available: { required: true, type: () => Boolean },
              content: { required: true, type: () => String },
              docnmKwd: { required: true, type: () => String },
              documentId: { required: true, type: () => String },
              id: { required: true, type: () => String },
              imageId: { required: true, type: () => String },
              importantKeywords: { required: true, type: () => [String] },
              positions: { required: true, type: () => [String] },
            },
          },
        ],
      ],
      controllers: [
        ...
        [
          import('./modules/monitor/login-log/login-log.controller'),
          {
            LoginLogController: {
              findOne: {
                summary: '\u83B7\u53D6\u767B\u5F55\u65E5\u5FD7\u8BE6\u60C5',
        ...
        [
          import('./modules/monitor/operation-log/operation-log.controller'),
          {
        ...
        [
          import('./modules/system/dict/dict.controller'),
          {
            DictController: {
              create: { summary: '\u521B\u5EFA\u5B57\u5178' },
              createData: { summary: '\u521B\u5EFA\u5B57\u5178\u6570\u636E' },
              delete: { summary: '\u5220\u9664\u5B57\u5178' },
              deleteData: { summary: '\u5220\u9664\u5B57\u5178\u6570\u636E' },
        ...
        [
          import('./modules/assistant/assistant.controller'),
          {
            AssistantController: {
              completions: {
                summary:
              ...
              remove: { summary: '\u5220\u9664\u804A\u5929\u52A9\u624B' },
              removeSession: {
                summary:
                  '\u5220\u9664\u4E0E\u804A\u5929\u52A9\u624B\u7684\u4F1A\u8BDD',
                type: Object,
              },
              update: { summary: '\u66F4\u65B0\u804A\u5929\u52A9\u624B' },
              updateSession: {
                summary:
                  '\u66F4\u65B0\u4E0E\u804A\u5929\u52A9\u624B\u7684\u4F1A\u8BDD',
              },
        ...
        [
          import('./modules/knowledge-base/knowledge-base.controller'),
          {
            KnowledgeBaseController: {
              create: { summary: '\u521B\u5EFA\u77E5\u8BC6\u5E93' },
              findAll: {
                summary: '\u83B7\u53D6\u77E5\u8BC6\u5E93\u5217\u8868',
              },
              findOne: {
              ...
              update: { summary: '\u66F4\u65B0\u77E5\u8BC6\u5E93' },
              remove: { summary: '\u5220\u9664\u77E5\u8BC6\u5E93' },
              findAllDocuments: { type: Object },
              uploadDocuments: {
                summary:
                  '\u4E0A\u4F20\u6587\u4EF6\u5230\u6307\u5B9A\u77E5\u8BC6\u5E93',
                type: Object,
